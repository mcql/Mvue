...
.logintit {
  ...
  font-size: 15px;
  font-weight: bold;
  background: -webkit-linear-gradient(#262626, #0f0f0f); /* Safari 5.1 - 6.0 */
  background: -o-linear-gradient(#262626, #0f0f0f); /* Opera 11.1 - 12.0 */
  background: -moz-linear-gradient(#262626, #0f0f0f); /* Firefox 3.6 - 15 */
  background: linear-gradient(#262626, #0f0f0f); /* 标准的语法 */
}
.titlecolor {
  width: 100%;
  height: 1px;
  background: -webkit-linear-gradient(#6b6b6b, #262626); /* Safari 5.1 - 6.0 */
  background: -o-linear-gradient(#6b6b6b, #262626); /* Opera 11.1 - 12.0 */
  background: -moz-linear-gradient(#6b6b6b, #262626); /* Firefox 3.6 - 15 */
  background: linear-gradient(#6b6b6b, #262626);
}
.logininfo {
  width: 240px;
  margin: 35px auto 0;
